...
import ReCounter from "../components/ReCounter.gen.js";

# Startpage

This is the boilerplate page for an Antwar based site.

- Edit `common/Routing.re` to add routes
...
<Interactive id="components/ReCounter.gen.js" component={ReCounter} count={0} />
